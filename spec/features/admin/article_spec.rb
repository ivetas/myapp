...
feature "Articles" do
  ...
  it "Admin sees all articles" do
    ...
    expect(page).to have_content I18n.t('destroy')
  end
  ...
  it "Admin can create new article and publish it" do
    click_link I18n.t('admin.articles.index.add_article')
    ...
    fill_in Article.human_attribute_name(:title), with: "Ēd cik uziet"
    fill_in Article.human_attribute_name(:description), with: "Jāēd 5 reizes dienā!"
    check Article.human_attribute_name(:published)
  ...
  it "Admin can edit article and attach file to it" do
    ...
    attach_file("article_photo", file_path)
